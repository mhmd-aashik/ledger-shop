...
export default function HeaderClient() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 will-change-transform header-scroll-optimized ${
        isScrolled
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              {favoritesCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-gradient-to-r from-red-500 to-red-600 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-medium shadow-lg transform-gpu will-change-transform count-badge">
                  {favoritesCount}
                </span>
              )}
            </Link>
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-gradient-to-r from-amber-600 to-amber-700 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-medium shadow-lg transform-gpu will-change-transform count-badge">
                  {cartCount}
                </span>
              )}
            </Link>
